...
def MessageListenerMethod(
    ...
    **methodKwargs
    ...
    def innerMethodWrapper(resourceInstanceMethod, *innerMethodArgs, **innerMethodKwargs) :
        ...
        @wrapperManager.api.app.route(f'{wrapperManager.api.baseUrl}{MessageConfig.LISTENER_URI}', methods=['POST'])
        def innerResourceInstanceMethod(*args, **kwargs):
            ...
            try:
                if wrapperManager.resourceInstance.logResponse or logResponse :
                    log.prettyJson(
                        wrapperManager.resourceInstanceMethod,
